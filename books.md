...
| Docker Cookbook 2E                           | Beginner     | Docker               | Fundamental to Intermediate | Not Yet        | -              | Packt free book                                                                                                                                                 |
...
| Git Notes                                    | Don't Know   | Git                  | -                           | No             | -              | This is a succinctly Notes                                                                                                                                      |
| HTML CSS Reference                           | Don't Know   | HTML & CSS           | -                           | No             | -              | This is a succinctly Notes                                                                                                                                      |
| HTML5 Canvas Notes                           | Don't Know   | HTML                 | -                           | No             | -              | This is a succinctly Notes                                                                                                                                      |
| HTML5 Notes                                  | Don't Know   | HTML                 | -                           | No             | -              | This is a succinctly Notes                                                                                                                                      |
| Introduction to Networking                   | Beginner     | -                    | Networking                  | No             | -              | -                                                                                                                                                               |
| JavaScript Notes                             | Don't Know   | JavaScript           | -                           | No             | -              | This is a succinctly Notes                                                                                                                                      |
| LaTeX Notes                                  | Don't Know   | LaTeX                | -                           | No             | -              | This is a succinctly Notes                                                                                                                                      |
| Learning Patterns                            | Don't Know   | JavaScript & React   | -                           | No             | -              | -                                                                                                                                                               |
| Mastering Kubernetes 2E                      | Don't Know   | Kubernetes           | -                           | No             | -              | Packt free book                                                                                                                                                 |
...
| PowerShell Notes                             | Don't Know   | PowerShell           | -                           | No             | -              | This is a succinctly Notes                                                                                                                                      |
...
| Responsive Web Design with HTML5 and CSS3 2E | Don't Know   | HTML & CSS           | -                           | No             | -              |                                                                                                                                                                 |
| SQL Notes                                    | Don't Know   | SQL                  | -                           | No             | -              | This is a succinctly Notes                                                                                                                                      |
| The Code Challenge Book                      | Don't Know   | -                    | -                           | No             | -              | -                                                                                                                                                               |
...
| Visual Studio Code Keyboard Shortcuts        | -            | -                    | -                           | No             | -              |                                                                                                                                                                 |
